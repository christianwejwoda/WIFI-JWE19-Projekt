        ...
        <form class="container-fluid" action="<?php echo basename(__FILE__, '.php'); ?>" method="post">
          ...
          <?php
            ...
            foreach ($zustelloptionen->get() as $zustelloption)
            {
              ...
              echo '<label class="form-label col-12 col-md-2 h5" for="zustelloption_' . $zustelloption->id . '_titel">Zustelloptionen ' . $zustelloption->id . ': </label>';
              ...
              echo '<input class="form-control col-5 col-md-3 text-right" type="text" name="zustelloption_' . $zustelloption->id . '_preis" id="zustelloption_' . $zustelloption->id . '_preis" value="' . str_replace('.',',',htmlspecialchars($zustelloption->preis)) . '">';
              echo '</div>';
            }
            echo '<div class="form-group row">';
            echo '<label class="form-label col-12 col-md-2 h5" for="zustelloption_neu_titel">Zustelloptionen NEU: </label>';
            ...
            echo '<label class="form-label col-6 d-block d-md-none">Preis</label>';
            echo '<input class="form-control col-5 col-md-3" type="text" name="zustelloption_neu_preis" id="zustelloption_neu_preis" value="';
